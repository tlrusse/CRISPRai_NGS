...
mkdir -p ${DATA_OUT}/15754-PP/alignment/
FASTQ1=${DATA_IN}/fastqs_15754-PP/15754-PP-1_S1_R1_001.fastq.gz
FASTQ2=${DATA_IN}/fastqs_15754-PP/15754-PP-1_S1_R2_001.fastq.gz
OUT_SAM=${DATA_OUT}/15754-PP/alignment/15754-PP-1_S1_001_pe.sam
OUT_LOG=${DATA_OUT}/15754-PP/alignment/15754-PP-1_S1_001_pe_bowtie2.log
